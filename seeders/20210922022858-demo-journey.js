    ...
    await queryInterface.bulkInsert("journeys", [
      {
        ...
        writer: "Veb",
        image: "http://localhost:3001/images/journey-1",
      ...
      },
      {
        ...
        writer: "Oni-on",
        image: "http://localhost:3001/images/journey-2",
      ...
      },
      {
        ...
        writer: "Rizky",
        image: "http://localhost:3001/images/journey-3",
      ...
      },
      {
        ...
        writer: "Cipto",
        image: "http://localhost:3001/images/journey-4",
